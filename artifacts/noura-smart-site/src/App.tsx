...
function Home() {
  ...
  return (
    <main className="noura-page" dir="rtl">
      ...
      <section id="contact" className="noura-contact"><div className="noura-wrap noura-contact-inner"><div><div className="noura-eyebrow"><span /> نكون قريبين عندما تحتاجنا</div><h2>عندك سؤال عن جهاز؟</h2><p>فريق نورة سمارت في الكويت جاهز يساعدك في اختيار المواصفات المناسبة.</p></div><div className="noura-contact-numbers"><a href="tel:+96555499000"><PhoneIcon /> +965 55499000</a><a href="tel:+96596004689"><PhoneIcon /> +965 96004689</a><a href="tel:+96558857532"><PhoneIcon /> +965 58857532</a></div></div></section>

      <footer className="noura-footer"><div className="noura-wrap"><div className="noura-footer-top"><a className="noura-logo" href="#top"><img src="/images/noura-smart-logo.png" alt="نورة" /><span><b>نورة سمارت</b><small>SMART HOME</small></span></a><p>تقنية أقرب. بيت أهدأ.</p><a href="#top" className="noura-back">العودة للأعلى <ChevronUp size={17} /></a></div><div className="noura-footer-bottom"><span>© نورة سمارت — الكويت</span><span className="noura-contact-links"><a href="tel:+96555499000">+965 55499000</a><a href="tel:+96596004689">+965 96004689</a><a href="tel:+96558857532">+965 58857532</a></span><span>الكتالوج التعريفي · المواصفات أولاً</span></div></div></footer>
